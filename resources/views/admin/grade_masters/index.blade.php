...
<body class="main">
        ...
        <div class="h-full flex items-center">
            ...
            <nav aria-label="breadcrumb" class="-intro-x h-full mr-auto">
                <ol class="breadcrumb breadcrumb-light">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">เกรดพื้นฐาน</li>
                </ol>
            </nav>
                                ...
                                <div class="grid grid-cols-12 mt-5">
                                    <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                                        ...
                                        <div class="flex justify-end mb-4">
                                            <a href="{{ url('admin/grade-masters/create') }}" class="btn btn-primary">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-report mt-2" id="grades-table">
                                                <thead>
                                                    <tr>
                                                        <th class="whitespace-nowrap text-center">ลำดับ</th>
                                                        <th class="whitespace-nowrap">รหัสเกรด</th>
                                                        <th class="whitespace-nowrap">ชื่อเกรด</th>
                                                            ...
                                                            <td class="text-center">
                                                                <div class="flex justify-center items-center">
                                                                    <a class="flex items-center mr-3"
                                                                        href="{{ url('admin/grade-masters/' . $value->id . '/edit') }}">
                                                                    ...
                                                                    <a href="javascript:void(0);"
                                                                        ...
                                                                        onclick="openDeleteModal({{ $value->id }}, '{{ addslashes($value->grade_name) }}')">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-0">
                    <form method="POST" action="{{ url('admin/grade-masters/delete') }}">
                        @csrf
    ...
    <script>
        function openDeleteModal(id, name) {
            ...
            deleteText.innerHTML = 'คุณต้องการลบเกรดพื้นฐาน <b>' + name +
