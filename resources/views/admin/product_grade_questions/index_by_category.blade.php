            ...
            <div class="content">
                <div class="intro-y flex items-center mt-8 mb-2">
                    <h2 class="text-lg font-medium mr-auto">
                        ชุดคำถามคัดเกรดสินค้า : {{ $categoryName }}
                    </h2>
                </div>
                                        ...
                                        <tbody>
                                            @forelse ($questions as $key => $value)
                                                <tr class="intro-x">
                                                    ...
                                                    <td class="text-center">{{ $value->options_count }}</td>
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="7" class="text-center text-slate-500 py-5">
                                                        ยังไม่มีข้อมูลชุดคำถามในประเภทนี้
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
    ...
    <script>
        function openDeleteModal(id, name) {
            ...
            document.getElementById('delete-text').innerHTML =
                'คุณต้องการลบชุดคำถาม <b>' + name + '</b> ใช่หรือไม่?<br>หากลบแล้วจะไม่สามารถกู้คืนข้อมูลเดิมได้';
