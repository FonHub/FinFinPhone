...
<body class="main">
    ...
    @php
        ...
        $brandName = $selectedBrand->brand_name ?? ($selectedBrand->name ?? '-');
    @endphp
        ...
        <div class="h-full flex items-center">
            ...
            <nav aria-label="breadcrumb" class="-intro-x h-full mr-auto">
                <ol class="breadcrumb breadcrumb-light">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ url('admin/product-grade-questions/by-category/' . $categoryId . '/brands') }}">
                            {{ $categoryName }}
                        </a>
                    </li>
                            ...
                            <div class="p-5 bg-slate-50 dark:bg-slate-700 rounded-lg">
                                ...
                                <div class="flex flex-wrap items-center justify-between gap-3 mb-4">
                                    <div class="text-slate-600 text-sm leading-6">
                                        ประเภทสินค้า: <b>{{ $categoryName }}</b>
                                        <span class="mx-2 text-slate-400">|</span>
                                        แบรนด์สินค้า: <b>{{ $brandName }}</b>
                                    </div>
                                    ...
                                    <div class="flex flex-wrap justify-end gap-2">
                                        ...
                                        <a href="{{ url('admin/product-grade-questions/create?mobile_product_category_id=' . $categoryId . '&mobile_brand_id=' . $brandId) }}"
                                                ...
                                                <tr class="intro-x">
                                                    ...
                                                    <td class="text-center">
                                                        @if ($value->answer_type === 'multiple')
                                                            <span class="px-3 py-1 rounded-full text-white bg-warning">
                                                                เลือกได้หลายข้อ
                                                            </span>
                                                        @else
                                                            <span class="px-3 py-1 rounded-full text-white bg-primary">
                                                                เลือกได้ข้อเดียว
                                                            </span>
                                                        @endif
                                                    </td>
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="7" class="text-center text-slate-500 py-5">
                                                        ยังไม่มีข้อมูลชุดคำถามในประเภทและแบรนด์นี้
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
