        ...
        <div class="h-full flex items-center">
            ...
            <nav aria-label="breadcrumb" class="-intro-x h-full mr-auto">
                <ol class="breadcrumb breadcrumb-light">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">รายการสายรถไฟฟ้า</li>
                </ol>
            </nav>
        ...
        <div class="wrapper-box">
            ...
            <div class="content">
                <div class="intro-y flex items-center mt-8 mb-5">
                    <h2 class="text-lg font-medium mr-auto">รายการสายรถไฟฟ้า</h2>
                </div>
                ...
                <div class="intro-y box p-5">
                    ...
                    <div class="flex justify-end mb-4">
                        <a href="{{ route('admin.transit-lines.create') }}" class="btn btn-primary">
                    ...
                    <div class="table-responsive">
                        <table class="table table-report mt-2" id="transit-lines-table">
                            <thead>
                                <tr>
                                    <th class="text-center">ลำดับ</th>
                                    <th>รหัสสาย</th>
                                    <th>ชื่อสายรถไฟฟ้า</th>
                                    <th>ผู้ให้บริการ</th>
                                    <th class="text-center">สีสาย</th>
                                    ...
                                    <tr>
                                            ...
                                            @if (!empty($line->line_color))
                                                <div class="flex items-center justify-center gap-2">
                                                    <span class="inline-block w-5 h-5 rounded-full border"
                                                        style="background-color: {{ $line->line_color }};"></span>
                                                    <span>{{ $line->line_color }}</span>
                                                </div>
                                            @else
                                        ...
                                        <td class="text-center">
                                            <div class="flex justify-center items-center gap-3">
                                                <a href="{{ route('admin.transit-lines.edit', $line->id) }}"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <form method="POST" action="{{ route('admin.transit-lines.delete') }}">
                                        @csrf
