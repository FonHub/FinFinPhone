                                ...
                                <div class="flex flex-wrap items-center justify-between gap-3 mb-4">
                                    ...
                                    <div class="flex flex-wrap justify-end gap-2">
                                        <a href="{{ url('admin/mobile-product-categories') }}"
                                            ...
                                            กลับไปหน้าประเภทสินค้า
                                        </a>

                                        <a href="{{ url('admin/product-questions/create?mobile_product_category_id=' . $categoryId) }}"
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="7" class="text-center text-slate-500 py-5">
                                                        ยังไม่มีข้อมูลคำถามสินค้าในประเภทนี้
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
    ...
    <script>
        function openDeleteModal(id, question) {
            ...
            document.getElementById('delete-text').innerHTML =
                'คุณต้องการลบคำถาม <b>' + question + '</b> ใช่หรือไม่?<br>หากลบแล้วจะไม่สามารถกู้คืนข้อมูลเดิมได้';
